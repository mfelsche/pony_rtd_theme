  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'pony_rtd_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'pony_rtd_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'pony_rtd_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['pony_rtd_theme/static/js/*.js', '!pony_rtd_theme/static/js/*.min.js'],
          dest: 'pony_rtd_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["pony_rtd_theme/static/fonts"],
      css: ["pony_rtd_theme/static/css"],
      js: ["pony_rtd_theme/static/js/*", "!pony_rtd_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['pony_rtd_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
